...
const setIntputInvalid = (form, input, errorMessage,{inputErrorClass, errorClass}) => {
...
const setInputValid = (form, input, {inputErrorClass, errorClass}) => {
  const elementError = form.querySelector(`#error-${input.id}`);
...
const checkInputValidity = (form, input, errorElement) => {
...
const toggleButtonValidity = (inputs, buttom, {inactiveButtonClass}) => {
